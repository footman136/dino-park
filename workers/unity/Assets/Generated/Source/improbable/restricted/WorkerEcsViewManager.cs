...
namespace Improbable.Restricted
{
    public partial class Worker
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            {
                Worker.ReferenceTypeProviders.WorkerIdProvider.CleanDataInWorld(world);
                Worker.ReferenceTypeProviders.WorkerTypeProvider.CleanDataInWorld(world);
            }
            ...
            private void RemoveComponent(EntityId entityId)
            {
                ...
                Worker.ReferenceTypeProviders.WorkerIdProvider.Free(data.workerIdHandle);
                Worker.ReferenceTypeProviders.WorkerTypeProvider.Free(data.workerTypeHandle);
