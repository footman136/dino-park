...
namespace Improbable.Restricted
{
    public partial class PlayerClient
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            {
                PlayerClient.ReferenceTypeProviders.PlayerIdentityProvider.CleanDataInWorld(world);
            }
            ...
            private void RemoveComponent(EntityId entityId)
            {
                ...
                PlayerClient.ReferenceTypeProviders.PlayerIdentityProvider.Free(data.playerIdentityHandle);
