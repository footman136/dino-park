    ...
    public partial class PlayerClient
    {
        ...
        public struct Component : IComponentData, ISpatialComponentData, ISnapshottable<Snapshot>
        {
            ...
            */
            ...
            {
                get => Improbable.Restricted.PlayerClient.ReferenceTypeProviders.PlayerIdentityProvider.Get(playerIdentityHandle);
                set
                {
                    MarkDataDirty(0);
                    Improbable.Restricted.PlayerClient.ReferenceTypeProviders.PlayerIdentityProvider.Set(playerIdentityHandle, value);
                }
            }
        }
        ...
        public static class Serialization
        {
            ...
            public static global::Improbable.Restricted.PlayerClient.Component Deserialize(global::Improbable.Worker.CInterop.SchemaObject obj, global::Unity.Entities.World world)
            {
                ...
                component.playerIdentityHandle = Improbable.Restricted.PlayerClient.ReferenceTypeProviders.PlayerIdentityProvider.Allocate(world);
                {
            ...
            public static global::Improbable.Restricted.PlayerClient.Update DeserializeUpdate(global::Improbable.Worker.CInterop.SchemaComponentUpdate updateObj)
            {
...

                {
                    ...
                    {
                        var value = global::Improbable.Restricted.PlayerIdentity.Serialization.Deserialize(obj.GetObject(1));
                        update.PlayerIdentity = new global::Improbable.Gdk.Core.Option<global::Improbable.Restricted.PlayerIdentity>(value);
                    }
            ...
            public static void ApplyUpdate(global::Improbable.Worker.CInterop.SchemaComponentUpdate updateObj, ref global::Improbable.Restricted.PlayerClient.Component component)
            {
...

                {
                    ...
                    {
                        var value = global::Improbable.Restricted.PlayerIdentity.Serialization.Deserialize(obj.GetObject(1));
                        component.PlayerIdentity = value;
                    }
        ...
        public struct ReceivedUpdates : IComponentData
        {
            ...
            {
                get => global::Improbable.Restricted.PlayerClient.ReferenceTypeProviders.UpdatesProvider.Get(handle);
            }
        }
#endif
        ...
        internal class PlayerClientDynamic : IDynamicInvokable
        {
            ...
            private static Update SnapshotToUpdate(in Snapshot snapshot)
            {
                ...
                update.PlayerIdentity = new Option<global::Improbable.Restricted.PlayerIdentity>(snapshot.PlayerIdentity);
                return update;
            }
