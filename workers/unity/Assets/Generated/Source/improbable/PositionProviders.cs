...
namespace Improbable
{
    public partial class Position
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<global::Improbable.Position.Update>> Storage = new Dictionary<uint, List<global::Improbable.Position.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Improbable.Position.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Improbable.Position.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<global::Improbable.Position.Update> value)
                {
