...
namespace Improbable.Gdk.PlayerLifecycle
{
    public partial class PlayerHeartbeatServer
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatServer.Update>> Storage = new Dictionary<uint, List<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatServer.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatServer.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatServer.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatServer.Update> value)
                {
