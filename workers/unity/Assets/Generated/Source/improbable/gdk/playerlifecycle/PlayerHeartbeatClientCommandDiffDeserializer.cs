...
namespace Improbable.Gdk.PlayerLifecycle
{
    public partial class PlayerHeartbeatClient
    {
        public class PlayerHeartbeatDiffCommandDeserializer : ICommandDiffDeserializer
        {
            ...
            {
                var deserializedRequest = global::Improbable.Gdk.Core.Empty.Serialization.Deserialize(op.Request.SchemaData.Value.GetObject());
            ...
            public void AddResponseToDiff(CommandResponseOp op, ViewDiff diff, CommandMetaDataAggregate commandMetaData)
            {
                ...
                var commandContext = commandMetaData.GetContext<global::Improbable.Gdk.Core.Empty>(ComponentId, 1, op.RequestId);
        ...
        public class PlayerHeartbeatCommandSerializer : ICommandSerializer
        {
            ...
            public void Serialize(MessagesToSend messages, SerializedMessagesToSend serializedMessages, CommandMetaData commandMetaData)
            {
                ...
                for (int i = 0; i < requests.Count; ++i)
                {
                    ...
                    var context = new CommandContext<global::Improbable.Gdk.Core.Empty>(request.SendingEntity, request.Request.Payload, request.Request.Context, request.RequestId);
                    commandMetaData.AddRequest<global::Improbable.Gdk.Core.Empty>(ComponentId, 1, in context);

                    var schemaCommandRequest = new global::Improbable.Worker.CInterop.SchemaCommandRequest(ComponentId, 1);
                    global::Improbable.Gdk.Core.Empty.Serialization.Serialize(request.Request.Payload, schemaCommandRequest.GetObject());
                ...
                for (int i = 0; i < responses.Count; ++i)
                {
                    ...
                    global::Improbable.Gdk.Core.Empty.Serialization.Serialize(response.Payload.Value, schemaCommandResponse.GetObject());
