...
[assembly: RegisterGenericComponentType(typeof(ComponentAdded<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>))]
[assembly: RegisterGenericComponentType(typeof(ComponentRemoved<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityChanges<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>))]
[assembly: RegisterGenericComponentType(typeof(Authoritative<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>))]
[assembly: RegisterGenericComponentType(typeof(NotAuthoritative<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityLossImminent<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>))]
    ...
    public partial class PlayerCreator
    {
        public class UpdateReactiveComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                for (int i = 0; i < updatesReceived.Count; ++i)
                {
                    ...
                    List<Update> updates;
                    if (entityManager.HasComponent<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.ReceivedUpdates>(entity))
                    {
                        updates = entityManager.GetComponentData<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.ReceivedUpdates>(entity).Updates;
                    }
                    else
                    {
            ...
            {
                global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.ReferenceTypeProviders.UpdatesProvider.CleanDataInWorld(world);
            }
        }
        ...
        public class LegacyAuthorityComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                foreach (var entityId in world.GetExistingSystem<EntitySystem>().GetEntitiesAdded())
                {
                    ...
                    entityManager.AddComponent(entity,
                        ComponentType.ReadWrite<NotAuthoritative<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>());
                }
            ...
            private void ApplyAuthorityChange(Unity.Entities.Entity entity, Authority authority, global::Improbable.Gdk.Core.EntityId entityId, World world, EntityManager entityManager)
            {
                switch (authority)
                {
                    case Authority.Authoritative:
                        if (!entityManager.HasComponent<NotAuthoritative<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.Authoritative, Authority.NotAuthoritative, entityId);
                            return;
                        }

                        entityManager.RemoveComponent<NotAuthoritative<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<Authoritative<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>());

                        break;
                    case Authority.AuthorityLossImminent:
                        if (!entityManager.HasComponent<Authoritative<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.AuthorityLossImminent, Authority.Authoritative, entityId);
                            return;
                        }

                        entityManager.AddComponent(entity, ComponentType.ReadWrite<AuthorityLossImminent<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>());
                        break;
                    case Authority.NotAuthoritative:
                        ...
                        if (entityManager.HasComponent<AuthorityLossImminent<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>(entity))
                        {
                            entityManager.RemoveComponent<AuthorityLossImminent<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>(entity);
                        }

                        entityManager.RemoveComponent<Authoritative<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<NotAuthoritative<global::Improbable.Gdk.PlayerLifecycle.PlayerCreator.Component>>());
                        break;
                }
            }
            ...
            private void LogInvalidAuthorityTransition(Authority newAuthority, Authority expectedOldAuthority, global::Improbable.Gdk.Core.EntityId entityId)
            {
                ...
                //     .WithField("Component", "global::Improbable.Gdk.PlayerLifecycle.PlayerCreator")
                // );
            }
        }
    }
