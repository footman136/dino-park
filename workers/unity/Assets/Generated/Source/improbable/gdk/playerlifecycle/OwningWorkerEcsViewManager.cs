    ...
    public partial class OwningWorker
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private void RemoveComponent(EntityId entityId)
            {
                ...
                var data = entityManager.GetComponentData<global::Improbable.Gdk.PlayerLifecycle.OwningWorker.Component>(entity);
                OwningWorker.ReferenceTypeProviders.WorkerIdProvider.Free(data.workerIdHandle);

                entityManager.RemoveComponent<global::Improbable.Gdk.PlayerLifecycle.OwningWorker.Component>(entity);
            }
