    ...
    public partial class Inventory
    {
        internal class ComponentReplicator : IComponentReplicationHandler
        {
            ...
            public EntityQueryDesc ComponentUpdateQuery => new EntityQueryDesc
            {
                All = new[]
                {
                    ComponentType.ReadWrite<global::Dinopark.Core.Inventory.Component>(),
                    ComponentType.ReadWrite<global::Dinopark.Core.Inventory.ComponentAuthority>(),
            ...
            {
                Profiler.BeginSample("Inventory");

                var spatialOSEntityType = system.GetArchetypeChunkComponentType<SpatialEntityId>(true);
                var componentType = system.GetArchetypeChunkComponentType<global::Dinopark.Core.Inventory.Component>();
