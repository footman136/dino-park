...
namespace Dinopark.Core
{
    public partial class Inventory
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<global::Dinopark.Core.Inventory.Update>> Storage = new Dictionary<uint, List<global::Dinopark.Core.Inventory.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Dinopark.Core.Inventory.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Dinopark.Core.Inventory.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<global::Dinopark.Core.Inventory.Update> value)
                {
