...
namespace Dinopark.Core
{
    public partial class TransformComponent
    {
        public class DiffComponentDeserializer : IComponentDiffDeserializer
        {
            ...
            {
                var update = global::Dinopark.Core.TransformComponent.Serialization.DeserializeUpdate(op.Update.SchemaData.Value);
...

                {
                    ...
                    if (eventCount > 0)
                    {
                        ...
                        {
                            var payload = global::Dinopark.Core.TeleportEvent.Serialization.Deserialize(eventsObject.IndexObject(1, i));
                            var e = new TeleportEvent.Event(payload);
        ...
        public class ComponentSerializer : IComponentSerializer
        {
            ...
            public void Serialize(MessagesToSend messages, SerializedMessagesToSend serializedMessages)
            {
                ...
                {
                    var events = ((IDiffEventStorage<TeleportEvent.Event>) storage).GetEvents();
                    ...
                    for (int i = 0; i < events.Count; ++i)
                    {
                        ...
                        global::Dinopark.Core.TeleportEvent.Serialization.Serialize(ev.Event.Payload, obj);
