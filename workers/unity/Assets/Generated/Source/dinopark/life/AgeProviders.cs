...
namespace Dinopark.Life
{
    public partial class Age
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<global::Dinopark.Life.Age.Update>> Storage = new Dictionary<uint, List<global::Dinopark.Life.Age.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Dinopark.Life.Age.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Dinopark.Life.Age.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<global::Dinopark.Life.Age.Update> value)
                {
