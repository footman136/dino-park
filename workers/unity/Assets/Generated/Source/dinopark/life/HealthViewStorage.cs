...
namespace Dinopark.Life
{
    ...
    {
        public class HealthViewStorage : IViewStorage, IViewComponentStorage<Snapshot>,
            IViewComponentUpdater<Update>
        {
            ...
            public void ApplyUpdate(long entityId, in Update update)
            {
                ...
                {
                    data.CurrentHealth = update.CurrentHealth.Value;
                }
                ...
                {
                    data.CanBeChanged = update.CanBeChanged.Value;
                }
