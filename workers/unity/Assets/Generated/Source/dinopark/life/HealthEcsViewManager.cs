    ...
    public partial class Health
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private void RemoveComponent(EntityId entityId)
            {
                ...
                entityManager.RemoveComponent<global::Dinopark.Life.Health.Component>(entity);
            }
            ...
            private void ApplyUpdate(in ComponentUpdateReceived<Update> update, ComponentDataFromEntity<Component> dataFromEntity)
            {
                ...
                if (update.Update.CurrentHealth.HasValue)
                {
                    data.CurrentHealth = update.Update.CurrentHealth.Value;
                }
                ...
                if (update.Update.CanBeChanged.HasValue)
                {
                    data.CanBeChanged = update.Update.CanBeChanged.Value;
                }
