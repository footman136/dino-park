...
[assembly: RegisterGenericComponentType(typeof(ComponentAdded<global::Dinopark.Player.PlayerAttrs.Component>))]
[assembly: RegisterGenericComponentType(typeof(ComponentRemoved<global::Dinopark.Player.PlayerAttrs.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityChanges<global::Dinopark.Player.PlayerAttrs.Component>))]
[assembly: RegisterGenericComponentType(typeof(Authoritative<global::Dinopark.Player.PlayerAttrs.Component>))]
[assembly: RegisterGenericComponentType(typeof(NotAuthoritative<global::Dinopark.Player.PlayerAttrs.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityLossImminent<global::Dinopark.Player.PlayerAttrs.Component>))]
    ...
    public partial class PlayerAttrs
    {
        public class UpdateReactiveComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                for (int i = 0; i < updatesReceived.Count; ++i)
                {
                    ...
                    List<Update> updates;
                    if (entityManager.HasComponent<global::Dinopark.Player.PlayerAttrs.ReceivedUpdates>(entity))
                    {
                        updates = entityManager.GetComponentData<global::Dinopark.Player.PlayerAttrs.ReceivedUpdates>(entity).Updates;
                    }
                    else
                    {
            ...
            {
                global::Dinopark.Player.PlayerAttrs.ReferenceTypeProviders.UpdatesProvider.CleanDataInWorld(world);
            }
        }
        ...
        public class LegacyAuthorityComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                foreach (var entityId in world.GetExistingSystem<EntitySystem>().GetEntitiesAdded())
                {
                    ...
                    entityManager.AddComponent(entity,
                        ComponentType.ReadWrite<NotAuthoritative<global::Dinopark.Player.PlayerAttrs.Component>>());
                }
            ...
            private void ApplyAuthorityChange(Unity.Entities.Entity entity, Authority authority, global::Improbable.Gdk.Core.EntityId entityId, World world, EntityManager entityManager)
            {
                switch (authority)
                {
                    case Authority.Authoritative:
                        if (!entityManager.HasComponent<NotAuthoritative<global::Dinopark.Player.PlayerAttrs.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.Authoritative, Authority.NotAuthoritative, entityId);
                            return;
                        }

                        entityManager.RemoveComponent<NotAuthoritative<global::Dinopark.Player.PlayerAttrs.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<Authoritative<global::Dinopark.Player.PlayerAttrs.Component>>());

                        break;
                    case Authority.AuthorityLossImminent:
                        if (!entityManager.HasComponent<Authoritative<global::Dinopark.Player.PlayerAttrs.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.AuthorityLossImminent, Authority.Authoritative, entityId);
                            return;
                        }

                        entityManager.AddComponent(entity, ComponentType.ReadWrite<AuthorityLossImminent<global::Dinopark.Player.PlayerAttrs.Component>>());
                        break;
                    case Authority.NotAuthoritative:
                        ...
                        if (entityManager.HasComponent<AuthorityLossImminent<global::Dinopark.Player.PlayerAttrs.Component>>(entity))
                        {
                            entityManager.RemoveComponent<AuthorityLossImminent<global::Dinopark.Player.PlayerAttrs.Component>>(entity);
                        }

                        entityManager.RemoveComponent<Authoritative<global::Dinopark.Player.PlayerAttrs.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<NotAuthoritative<global::Dinopark.Player.PlayerAttrs.Component>>());
                        break;
                }
            }
            ...
            private void LogInvalidAuthorityTransition(Authority newAuthority, Authority expectedOldAuthority, global::Improbable.Gdk.Core.EntityId entityId)
            {
                ...
                //     .WithField("Component", "global::Dinopark.Player.PlayerAttrs")
                // );
            }
        }
    }
