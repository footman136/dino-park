...
[assembly: RegisterGenericComponentType(typeof(ComponentAdded<global::Dinopark.Plants.Harvestable.Component>))]
[assembly: RegisterGenericComponentType(typeof(ComponentRemoved<global::Dinopark.Plants.Harvestable.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityChanges<global::Dinopark.Plants.Harvestable.Component>))]
[assembly: RegisterGenericComponentType(typeof(Authoritative<global::Dinopark.Plants.Harvestable.Component>))]
[assembly: RegisterGenericComponentType(typeof(NotAuthoritative<global::Dinopark.Plants.Harvestable.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityLossImminent<global::Dinopark.Plants.Harvestable.Component>))]
    ...
    public partial class Harvestable
    {
        public class UpdateReactiveComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                for (int i = 0; i < updatesReceived.Count; ++i)
                {
                    ...
                    List<Update> updates;
                    if (entityManager.HasComponent<global::Dinopark.Plants.Harvestable.ReceivedUpdates>(entity))
                    {
                        updates = entityManager.GetComponentData<global::Dinopark.Plants.Harvestable.ReceivedUpdates>(entity).Updates;
                    }
                    else
                    {
            ...
            {
                global::Dinopark.Plants.Harvestable.ReferenceTypeProviders.UpdatesProvider.CleanDataInWorld(world);
            }
        }
        ...
        public class LegacyAuthorityComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                foreach (var entityId in world.GetExistingSystem<EntitySystem>().GetEntitiesAdded())
                {
                    ...
                    entityManager.AddComponent(entity,
                        ComponentType.ReadWrite<NotAuthoritative<global::Dinopark.Plants.Harvestable.Component>>());
                }
            ...
            private void ApplyAuthorityChange(Unity.Entities.Entity entity, Authority authority, global::Improbable.Gdk.Core.EntityId entityId, World world, EntityManager entityManager)
            {
                switch (authority)
                {
                    case Authority.Authoritative:
                        if (!entityManager.HasComponent<NotAuthoritative<global::Dinopark.Plants.Harvestable.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.Authoritative, Authority.NotAuthoritative, entityId);
                            return;
                        }

                        entityManager.RemoveComponent<NotAuthoritative<global::Dinopark.Plants.Harvestable.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<Authoritative<global::Dinopark.Plants.Harvestable.Component>>());

                        break;
                    case Authority.AuthorityLossImminent:
                        if (!entityManager.HasComponent<Authoritative<global::Dinopark.Plants.Harvestable.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.AuthorityLossImminent, Authority.Authoritative, entityId);
                            return;
                        }

                        entityManager.AddComponent(entity, ComponentType.ReadWrite<AuthorityLossImminent<global::Dinopark.Plants.Harvestable.Component>>());
                        break;
                    case Authority.NotAuthoritative:
                        ...
                        if (entityManager.HasComponent<AuthorityLossImminent<global::Dinopark.Plants.Harvestable.Component>>(entity))
                        {
                            entityManager.RemoveComponent<AuthorityLossImminent<global::Dinopark.Plants.Harvestable.Component>>(entity);
                        }

                        entityManager.RemoveComponent<Authoritative<global::Dinopark.Plants.Harvestable.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<NotAuthoritative<global::Dinopark.Plants.Harvestable.Component>>());
                        break;
                }
            }
            ...
            private void LogInvalidAuthorityTransition(Authority newAuthority, Authority expectedOldAuthority, global::Improbable.Gdk.Core.EntityId entityId)
            {
                ...
                //     .WithField("Component", "global::Dinopark.Plants.Harvestable")
                // );
            }
        }
    }
