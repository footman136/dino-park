...
namespace Dinopark.Plants
{
    public partial class TreeState
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<global::Dinopark.Plants.TreeState.Update>> Storage = new Dictionary<uint, List<global::Dinopark.Plants.TreeState.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Dinopark.Plants.TreeState.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Dinopark.Plants.TreeState.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<global::Dinopark.Plants.TreeState.Update> value)
                {
