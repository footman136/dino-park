...
namespace Dinopark.Npc
{
    public partial class TargetNavigation
    {
        public class DiffComponentDeserializer : IComponentDiffDeserializer
        {
            ...
            {
                var update = global::Dinopark.Npc.TargetNavigation.Serialization.DeserializeUpdate(op.Update.SchemaData.Value);
...

                {
                    ...
                    if (eventCount > 0)
                    {
                        ...
                        {
                            var payload = global::Dinopark.Npc.NavigationFinished.Serialization.Deserialize(eventsObject.IndexObject(1, i));
                            var e = new NavigationFinished.Event(payload);
        ...
        public class ComponentSerializer : IComponentSerializer
        {
            ...
            public void Serialize(MessagesToSend messages, SerializedMessagesToSend serializedMessages)
            {
                ...
                {
                    var events = ((IDiffEventStorage<NavigationFinished.Event>) storage).GetEvents();
                    ...
                    for (int i = 0; i < events.Count; ++i)
                    {
                        ...
                        global::Dinopark.Npc.NavigationFinished.Serialization.Serialize(ev.Event.Payload, obj);
