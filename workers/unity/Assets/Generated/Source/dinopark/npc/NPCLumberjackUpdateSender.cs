    ...
    public partial class NPCLumberjack
    {
        internal class ComponentReplicator : IComponentReplicationHandler
        {
            ...
            public EntityQueryDesc ComponentUpdateQuery => new EntityQueryDesc
            {
                All = new[]
                {
                    ComponentType.ReadWrite<global::Dinopark.Npc.NPCLumberjack.Component>(),
                    ComponentType.ReadWrite<global::Dinopark.Npc.NPCLumberjack.ComponentAuthority>(),
            ...
            {
                Profiler.BeginSample("NPCLumberjack");

                var spatialOSEntityType = system.GetArchetypeChunkComponentType<SpatialEntityId>(true);
                var componentType = system.GetArchetypeChunkComponentType<global::Dinopark.Npc.NPCLumberjack.Component>();
