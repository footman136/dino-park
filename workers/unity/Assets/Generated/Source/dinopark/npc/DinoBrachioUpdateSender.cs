    ...
    public partial class DinoBrachio
    {
        internal class ComponentReplicator : IComponentReplicationHandler
        {
            ...
            public EntityQueryDesc ComponentUpdateQuery => new EntityQueryDesc
            {
                All = new[]
                {
                    ComponentType.ReadWrite<global::Dinopark.Npc.DinoBrachio.Component>(),
                    ComponentType.ReadWrite<global::Dinopark.Npc.DinoBrachio.ComponentAuthority>(),
            ...
            {
                Profiler.BeginSample("DinoBrachio");

                var spatialOSEntityType = system.GetArchetypeChunkComponentType<SpatialEntityId>(true);
                var componentType = system.GetArchetypeChunkComponentType<global::Dinopark.Npc.DinoBrachio.Component>();
