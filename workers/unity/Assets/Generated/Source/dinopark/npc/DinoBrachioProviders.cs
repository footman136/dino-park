...
namespace Dinopark.Npc
{
    public partial class DinoBrachio
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<global::Dinopark.Npc.DinoBrachio.Update>> Storage = new Dictionary<uint, List<global::Dinopark.Npc.DinoBrachio.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Dinopark.Npc.DinoBrachio.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Dinopark.Npc.DinoBrachio.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<global::Dinopark.Npc.DinoBrachio.Update> value)
                {
