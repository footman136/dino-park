...
namespace Dinopark.Npc
{
    ...
    {
        public class HatchDiffCommandDeserializer : ICommandDiffDeserializer
        {
            ...
            {
                var deserializedRequest = global::Dinopark.Npc.HatchRequest.Serialization.Deserialize(op.Request.SchemaData.Value.GetObject());

                var request = new Hatch.ReceivedRequest(
            ...
            {
                global::Dinopark.Npc.HatchResponse? rawResponse = null;
                if (op.StatusCode == StatusCode.Success)
                {
                    rawResponse = global::Dinopark.Npc.HatchResponse.Serialization.Deserialize(op.Response.SchemaData.Value.GetObject());
                }

                var commandContext = commandMetaData.GetContext<global::Dinopark.Npc.HatchRequest>(ComponentId, 1, op.RequestId);
                commandMetaData.MarkIdForRemoval(ComponentId, 1, op.RequestId);

                var response = new Hatch.ReceivedResponse(
        ...
        public class HatchCommandSerializer : ICommandSerializer
        {
            public uint GetComponentId()
            {
                return ComponentId;
            ...
            {
                var storage = (HatchCommandsToSendStorage) messages.GetCommandSendStorage(ComponentId, 1);
                ...
                for (int i = 0; i < requests.Count; ++i)
                {
                    ...
                    var context = new CommandContext<global::Dinopark.Npc.HatchRequest>(request.SendingEntity, request.Request.Payload, request.Request.Context, request.RequestId);
                    commandMetaData.AddRequest<global::Dinopark.Npc.HatchRequest>(ComponentId, 1, in context);

                    var schemaCommandRequest = new global::Improbable.Worker.CInterop.SchemaCommandRequest(ComponentId, 1);
                    global::Dinopark.Npc.HatchRequest.Serialization.Serialize(request.Request.Payload, schemaCommandRequest.GetObject());
                ...
                for (int i = 0; i < responses.Count; ++i)
                {
                    ...
                    global::Dinopark.Npc.HatchResponse.Serialization.Serialize(response.Payload.Value, schemaCommandResponse.GetObject());
