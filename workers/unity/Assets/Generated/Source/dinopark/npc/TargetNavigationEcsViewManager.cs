    ...
    public partial class TargetNavigation
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private void RemoveComponent(EntityId entityId)
            {
                ...
                entityManager.RemoveComponent<global::Dinopark.Npc.TargetNavigation.Component>(entity);
            }
            ...
            private void ApplyUpdate(in ComponentUpdateReceived<Update> update, ComponentDataFromEntity<Component> dataFromEntity)
            {
                ...
                if (update.Update.NavigationState.HasValue)
                {
                    data.NavigationState = update.Update.NavigationState.Value;
                }
                ...
                if (update.Update.InteractionSqrDistance.HasValue)
                {
                    data.InteractionSqrDistance = update.Update.InteractionSqrDistance.Value;
                }
