...
[assembly: RegisterGenericComponentType(typeof(ComponentAdded<global::Com.Infalliblecode.PlayerTransform.Component>))]
[assembly: RegisterGenericComponentType(typeof(ComponentRemoved<global::Com.Infalliblecode.PlayerTransform.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityChanges<global::Com.Infalliblecode.PlayerTransform.Component>))]
[assembly: RegisterGenericComponentType(typeof(Authoritative<global::Com.Infalliblecode.PlayerTransform.Component>))]
[assembly: RegisterGenericComponentType(typeof(NotAuthoritative<global::Com.Infalliblecode.PlayerTransform.Component>))]
[assembly: RegisterGenericComponentType(typeof(AuthorityLossImminent<global::Com.Infalliblecode.PlayerTransform.Component>))]
    ...
    public partial class PlayerTransform
    {
        public class UpdateReactiveComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                for (int i = 0; i < updatesReceived.Count; ++i)
                {
                    ...
                    List<Update> updates;
                    if (entityManager.HasComponent<global::Com.Infalliblecode.PlayerTransform.ReceivedUpdates>(entity))
                    {
                        updates = entityManager.GetComponentData<global::Com.Infalliblecode.PlayerTransform.ReceivedUpdates>(entity).Updates;
                    }
                    else
                    {
            ...
            {
                global::Com.Infalliblecode.PlayerTransform.ReferenceTypeProviders.UpdatesProvider.CleanDataInWorld(world);
            }
        }
        ...
        public class LegacyAuthorityComponentManager : IReactiveComponentManager
        {
            public void PopulateReactiveComponents(ComponentUpdateSystem updateSystem, EntityManager entityManager, WorkerSystem workerSystem, World world)
            {
                ...
                foreach (var entityId in world.GetExistingSystem<EntitySystem>().GetEntitiesAdded())
                {
                    ...
                    entityManager.AddComponent(entity,
                        ComponentType.ReadWrite<NotAuthoritative<global::Com.Infalliblecode.PlayerTransform.Component>>());
                }
            ...
            private void ApplyAuthorityChange(Unity.Entities.Entity entity, Authority authority, global::Improbable.Gdk.Core.EntityId entityId, World world, EntityManager entityManager)
            {
                switch (authority)
                {
                    case Authority.Authoritative:
                        if (!entityManager.HasComponent<NotAuthoritative<global::Com.Infalliblecode.PlayerTransform.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.Authoritative, Authority.NotAuthoritative, entityId);
                            return;
                        }

                        entityManager.RemoveComponent<NotAuthoritative<global::Com.Infalliblecode.PlayerTransform.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<Authoritative<global::Com.Infalliblecode.PlayerTransform.Component>>());

                        break;
                    case Authority.AuthorityLossImminent:
                        if (!entityManager.HasComponent<Authoritative<global::Com.Infalliblecode.PlayerTransform.Component>>(entity))
                        {
                            LogInvalidAuthorityTransition(Authority.AuthorityLossImminent, Authority.Authoritative, entityId);
                            return;
                        }

                        entityManager.AddComponent(entity, ComponentType.ReadWrite<AuthorityLossImminent<global::Com.Infalliblecode.PlayerTransform.Component>>());
                        break;
                    case Authority.NotAuthoritative:
                        ...
                        if (entityManager.HasComponent<AuthorityLossImminent<global::Com.Infalliblecode.PlayerTransform.Component>>(entity))
                        {
                            entityManager.RemoveComponent<AuthorityLossImminent<global::Com.Infalliblecode.PlayerTransform.Component>>(entity);
                        }

                        entityManager.RemoveComponent<Authoritative<global::Com.Infalliblecode.PlayerTransform.Component>>(entity);
                        entityManager.AddComponent(entity, ComponentType.ReadWrite<NotAuthoritative<global::Com.Infalliblecode.PlayerTransform.Component>>());
                        break;
                }
            }
            ...
            private void LogInvalidAuthorityTransition(Authority newAuthority, Authority expectedOldAuthority, global::Improbable.Gdk.Core.EntityId entityId)
            {
                ...
                //     .WithField("Component", "global::Com.Infalliblecode.PlayerTransform")
                // );
            }
        }
    }
