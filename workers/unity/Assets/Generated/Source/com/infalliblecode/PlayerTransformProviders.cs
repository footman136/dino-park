...
namespace Com.Infalliblecode
{
    public partial class PlayerTransform
    {
        internal static class ReferenceTypeProviders
        {
            ...
            {
                private static readonly Dictionary<uint, List<global::Com.Infalliblecode.PlayerTransform.Update>> Storage = new Dictionary<uint, List<global::Com.Infalliblecode.PlayerTransform.Update>>();
                ...
                public static uint Allocate(global::Unity.Entities.World world)
                {
                    ...
                    Storage.Add(handle, default(List<global::Com.Infalliblecode.PlayerTransform.Update>));
                    WorldMapping.Add(handle, world);
            
                    return handle;
                }
            
                public static List<global::Com.Infalliblecode.PlayerTransform.Update> Get(uint handle)
                {
                ...
                public static void Set(uint handle, List<global::Com.Infalliblecode.PlayerTransform.Update> value)
                {
